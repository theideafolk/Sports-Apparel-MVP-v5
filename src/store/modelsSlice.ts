  ...
  models: [
    {
      id: 'jersey_1',
      name: 'Soccer Jersey',
      path: '/public/assets/3DObjects/Jersey/jersey_1.obj',
      productType: 'jersey',
    ...
    },
    {
      ...
      path: '/public/assets/3DObjects/Jersey/Softball.obj',
    ...
    },
    {
      ...
      path: '/public/assets/3DObjects/Jersey/RoundNeck.obj',
      productType: 'jersey'
    },
    {
      id: 'socks_1',
      name: 'Short Socks',
      path: '/public/assets/3DObjects/Socks/socks_1.obj',
...

    {
      id: 'socks_2',
      name: 'Long Socks',
      path: '/public/assets/3DObjects/Socks/socks_2.obj',
